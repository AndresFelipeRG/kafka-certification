...
public class ConsumerPurchaseSchemaRegistry {
    ...
    public static void main(String [] args){
        ...
        props.put(KakfkaAvroDeserializerConfig.SPECIFIC_AVRO_READER_CONFIG, true);
        ...
        try{
            ...
            while(true){
                final ConsumerRecord<String, Purchase> records = new consumer.poll(Duration.ofMillis(100));
