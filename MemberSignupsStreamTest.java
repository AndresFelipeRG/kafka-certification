...
public class MemberSignupsStreamTest {
    ...
    public void test_empty_name_filter(){
        ...
        testDriver.pipeInput(record);
        ProducerRecord<Integer, String> outputRecord = testDriver.readOutput("member_signupts_email", new IntegerDeserializer(), new StringDeserializer());
